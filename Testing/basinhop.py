...
#MODIFIED FROM SCIPY.OPTIMISE:  https://github.com/scipy/scipy/blob/master/scipy/optimize/_basinhopping.py
...
def basinhopping(func, x0, niter=100, T=1.0, stepsize=0.5,
                 minimizer_kwargs=None, minima=0, take_step=None, accept_test=None,
    ...
    for i in range(niter):
        ...
        if abs(func(bh.sol())- minima) < 1e-3 and success == False:
            nfesuccess = bh.nfe()
            success = True
